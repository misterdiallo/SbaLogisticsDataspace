# Logistics Connector Data Dashboard

**Please note: This repository does not contain production-grade code and is only intended for demonstration purposes.**

Logistics Connector Data Dashboard is a dev frontend application for [Logistics Connector Management API](https://github.com/eclipse-edc/Connector).
...
- `apiKey`: enter here what your Logistics Connector instance expects in th `x-api-key` header

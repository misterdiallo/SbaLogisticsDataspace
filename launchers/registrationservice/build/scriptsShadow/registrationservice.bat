...
set CLASSPATH=%APP_HOME%\lib\registrationservice.jar

@rem Execute registrationservice
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %REGISTRATIONSERVICE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%REGISTRATIONSERVICE_EXIT_CONSOLE%" exit 1
exit /b 1
